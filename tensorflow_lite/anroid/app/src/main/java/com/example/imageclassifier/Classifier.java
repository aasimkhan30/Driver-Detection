...
import static com.example.imageclassifier.ModelConfig.CLASSIFICATION_THRESHOLD;
import static com.example.imageclassifier.ModelConfig.MAX_CLASSIFICATION_RESULTS;
...
public class Classifier {
    ...
    public List<Classifier> recognizeImage(Bitmap bitmap) {
